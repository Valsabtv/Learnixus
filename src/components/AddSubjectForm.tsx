...
const AddSubjectForm: React.FC<AddSubjectFormProps> = ({ onAddSubject, onClose }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        <label htmlFor="subjectName" className={`block text-sm font-medium ${labelColorClass} mb-1.5`}>
          Subject Name
        </label>
        <input
          type="text"
